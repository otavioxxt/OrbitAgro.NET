...
API disponível em: https://orbitagronet-production.up.railway.app/swagger
...
- `/api/FonteSatelite` - CRUD de fontes de satélite
- `/api/LogErro` - CRUD de logs de erro
...
- TB_FONTE_SATELITE 1:N TB_MONITORAMENTO
- TB_LOG_ERRO (registro de erros do sistema)
